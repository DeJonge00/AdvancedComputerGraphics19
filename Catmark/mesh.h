...
public:
    ...
    QVector<unsigned int> getPatchesVertexIndices(int nr_patches);
    QVector<QVector3D> getPatchesCoords(int nr_patches);
    QVector<QVector3D> getPatchesNormals(int nr_patches);
