...
"}"));
        ...
        selectedCircle = new QSpinBox(mainGB);
        selectedCircle->setObjectName(QString::fromUtf8("selectedCircle"));
        selectedCircle->setGeometry(QRect(40, 500, 151, 27));
        stepsLabel_2 = new QLabel(mainGB);
        stepsLabel_2->setObjectName(QString::fromUtf8("stepsLabel_2"));
        stepsLabel_2->setGeometry(QRect(40, 470, 151, 18));
        ...
        QObject::connect(selectedCircle, SIGNAL(valueChanged(int)), mainView, SLOT(setSelectedCircle(int)));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        stepsLabel_2->setText(QApplication::translate("MainWindow", "Draw circle on selected curve", nullptr));
    } // retranslateUi
